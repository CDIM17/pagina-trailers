...
<h1 class="titulo"><strong>USUARIOS</strong> </h1>
...
<table class="table table-striped table-dark tabla">
  ...
  <?php foreach($result as $row){ ?>
    <tr>
      ...
      <td><a href="usuario-edit.php?id=<?php echo $row['id_usuario']?>" class="btn btn-primary">Editar</a></td>
     
      <td><a href="usuario-delete.php?id=<?php echo $row['id_usuario']?>" class="btn btn-danger" >Delete</a></td>
    </tr>
        <?php }?>
    </tbody>
